...
router.get('/', (req, res) => {
  res.json({ message: 'Welcome to the RiderMind API' });
});
...
import adminStudentModulesRouter from './admin/student-modules.js';
...
router.use('/admin/student-modules', adminStudentModulesRouter);
