      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-2xl font-bold text-white">RiderMind</span>
          </div>

          <h1 className="text-5xl font-bold text-left tracking-tight text-white leading-tight">
            Drive with<br />
            <span className="text-brand-700">confidence</span>
          </h1>
          <p className="text-base my-6 text-neutral-100 leading-relaxed max-w-md text-left">
          ...
          <div className="flex gap-8 mt-10">
            <div>
              ...
              <div className="text-sm text-neutral-200">Modules</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white">100%</div>
              <div className="text-sm text-neutral-200">Free Access</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white">24/7</div>
              <div className="text-sm text-neutral-200">Available</div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="bottom-0 absolute p-6 text-center right-0 left-0 flex justify-center space-x-4">
          <span className="w-10 h-10 items-center justify-center inline-flex rounded-full bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-colors cursor-pointer">
            <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
