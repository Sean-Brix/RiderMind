        ...
        >
          ...
          <div className="grid gap-6">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-neutral-800 rounded-xl shadow-lg border border-neutral-200 dark:border-neutral-700 p-8"
            >
            ...
            <motion.div
              ...
              className="bg-white dark:bg-neutral-800 rounded-xl shadow-lg border border-neutral-200 dark:border-neutral-700 p-8 opacity-50"
            >
