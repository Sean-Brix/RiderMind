        ...
        <div className="mt-6 pt-4 border-t border-neutral-200 dark:border-neutral-800 space-y-2">
          {actions.map((action, idx) => (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 rounded-lg transition-all shadow-sm hover:shadow-md"
            >
              {action.icon}
              {action.label}
            </button>
