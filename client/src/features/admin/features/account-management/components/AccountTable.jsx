                  ...
                  {u.orNumber ? (
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs font-mono text-neutral-900 dark:text-neutral-100">{u.orNumber}</span>
                      </div>
                      {u.paymentReceiptUrl && (
                        <a
                    ...
                    <span className="text-xs text-neutral-400 dark:text-neutral-500 italic">No payment info</span>
                  )}
                </td>
