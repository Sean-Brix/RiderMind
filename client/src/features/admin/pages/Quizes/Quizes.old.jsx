...
export default function Quizes() {
  ...
  return (
    <div className="p-6">
      {/* Loading State */}
      {loading && (
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow border border-neutral-200 dark:border-neutral-700 p-12 text-center">
      ...
      {/* Main Content */}
      {!loading && !error && (
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow border border-neutral-200 dark:border-neutral-700">
          {/* Tabs */}
            ...
            {activeTab === 'quizzes' ? (
              <div className="flex gap-6">
                ...
                <div className="w-80 flex-shrink-0">
                  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 sticky top-6 h-[calc(100vh-120px)] flex flex-col">
                          ...
                          <div className="p-4 bg-neutral-50 dark:bg-neutral-900 rounded-lg border-2 border-brand-500 space-y-4">
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                className="w-full px-4 py-2 bg-white dark:bg-gray-900 border border-neutral-300 dark:border-neutral-600 rounded-lg resize-none"
                              />
                            </div>
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-2 bg-white dark:bg-gray-900 border border-neutral-300 dark:border-neutral-600 rounded-lg"
                              />
                            </div>
                            ...
                            <div className="border border-neutral-200 dark:border-neutral-700 rounded-lg overflow-hidden">
                              <button
                                ...
                                className="w-full px-4 py-3 bg-neutral-50 dark:bg-gray-900 hover:bg-neutral-100 dark:hover:bg-neutral-750 flex items-center justify-between transition-colors"
                              >
                                <div className="flex items-center gap-2">
                                  ...
                                  {questionForm.options.map((option, index) => (
                                    <div key={index} className={`flex items-center gap-2 p-3 rounded-lg border-2 transition-all ${
                                      option.isCorrect 
                                        ...
                                        : 'bg-white dark:bg-gray-900 border-neutral-300 dark:border-neutral-600'
                                    }`}>
                                      <div className="flex items-center gap-2">
                                        <input
