...
function FeedbackAnalytics({ data }) {
  ...
  return (
    <div className="space-y-4">
      {/* Stats Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        <StatCard title="Total Feedback" value={data.totalFeedback.toLocaleString()} icon="💬" color="blue" />
        <StatCard title="Positive" value={data.positive.toLocaleString()} icon="👍" color="green" />
        <StatCard title="Neutral" value={data.neutral.toLocaleString()} icon="😐" color="yellow" />
        <StatCard title="Negative" value={data.negative.toLocaleString()} icon="👎" color="red" />
      </div>

      {/* Average Rating and Sentiment Pie */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-4">
          <h3 className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 mb-3">Average Rating</h3>
          <div className="flex items-center gap-3">
            <div className="text-4xl font-bold text-brand-600 dark:text-brand-400">{data.avgRating}</div>
            <div>
              ...
              <div className="text-xs text-neutral-600 dark:text-neutral-400">out of 5</div>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-4">
          <h3 className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 mb-3">Sentiment Distribution</h3>
