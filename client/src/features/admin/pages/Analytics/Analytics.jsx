      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-neutral-900 dark:text-neutral-100 mt-2">0</p>
                </div>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400">Quiz Completions</p>
                  <p className="text-3xl font-bold text-neutral-900 dark:text-neutral-100 mt-2">0</p>
                </div>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400">Feedback Count</p>
                  <p className="text-3xl font-bold text-neutral-900 dark:text-neutral-100 mt-2">0</p>
                </div>
