                      ...
                      <div className="space-y-3 min-h-[400px]">
                        ...
                        {activeModules.length === 0 && (
                          <div className="text-center py-20 text-sm text-neutral-500 dark:text-neutral-400 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border-2 border-dashed border-neutral-300 dark:border-neutral-600 h-full flex flex-col items-center justify-center min-h-[400px]">
                            ...
                            <p className="font-medium text-neutral-900 dark:text-neutral-100 mb-1">No active modules</p>
                            <p className="text-xs mb-4">
                              {isEditMode ? 'Drag modules from the sidebar to activate them' : 'Get started by creating your first module'}
                            </p>
                            {!isEditMode && availableModules.length === 0 && (
                              <button
                                onClick={() => {
                                  setActiveTab('new');
                                  handleCreateNewModule();
